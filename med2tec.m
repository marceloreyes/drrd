...
% Last modified by: Marcelo
% Modification:     Change resolution from 0.005 to 0.002 for recorded
%                   events
% 
...
%                   an integer number of 5-ms units. Event is an integer
%                   code
%
...
function Time_event = med2tec(fNAME)
